...
SOURCEFILES_QUOTED_IF_SPACED=uart.c main_UART.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/uart.p1 ${OBJECTDIR}/main_UART.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/uart.p1.d ${OBJECTDIR}/main_UART.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/uart.p1 ${OBJECTDIR}/main_UART.p1

# Source Files
SOURCEFILES=uart.c main_UART.c
...
${OBJECTDIR}/main_UART.p1: main_UART.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/main_UART.p1.d 
	@${RM} ${OBJECTDIR}/main_UART.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/main_UART.p1 main_UART.c 
	@-${MV} ${OBJECTDIR}/main_UART.d ${OBJECTDIR}/main_UART.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/main_UART.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
